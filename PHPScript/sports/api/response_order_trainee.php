    ...
    if ($result) {
        ...
        if ($user_id) {
            ...
            if ($_POST['status'] == "Approve") {
                $content = "Your Order is Approved";
            } else if ($_POST['status'] == "Disapprove") {
                $content = "Your Order is Disapproved.";
            } else if ($_POST['status'] == "Completedd") {
                $content = "Your Order is Completedd.";
            } else if ($_POST['status'] == "Cancel") {
                $content = "Your Order is Canceled.";
            } else {
            ...
            $sqlusers = "select * from  tbl_notification_users where user_id = " . $user;
            $res = $db->query($sqlusers)->fetch();
