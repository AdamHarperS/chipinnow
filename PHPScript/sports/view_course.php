                                        ...
                                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo get_value("course_city"); ?></th>
                                                    ...
                                                    foreach ($rows as $record) {
                                                        ...
                                                        <tr>
                                                            <td> <input type="checkbox" class="ckbox" id="ckb<?php echo $record['id']; ?>" name="ckb[]" value="<?php echo $record['id']; ?>">
                                                                <?php echo $counter; ?></td>
                                                            <td><img src="images/course/<?php echo $record ['image']; ?>" width="50px" height="50px"></td>
                                                            ...
                                                            <td class="translate"><a style="color:#fff" class="btn btn-primary btn-xs" href="add_course.php?edit=<?php echo $record['id']; ?>"><i class="fa fa-edit"></i> <?php echo get_value("edit"); ?></a></td>
                                                        </tr>
                                                        <?php
                                                        $counter++;
                                                    }
