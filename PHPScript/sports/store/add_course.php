                                ...
                                <div class="x_content">
                                    ...
                                    <form class="form-horizontal form-label-left" novalidate method="post" action="<?php echo $action_url; ?>">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            ?>
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo get_value('select_trainer'); ?></label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select class="form-control" name="trainer_id" id="trainer_id">
                                                    <option value=""><?php echo get_value('select_trainer'); ?></option>
                                                    <?php
                                        ...
                                        <div class="item form-group">
                                            ...
                                            ?>
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="course_location"><?php echo get_value('course_location'); ?> <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="course_location" class="form-control col-md-7 col-xs-12 "  value="<?php echo $controlEditName; ?>"  name="course_location" placeholder="" required="required" type="text">
                                            </div>
                                        </div>
